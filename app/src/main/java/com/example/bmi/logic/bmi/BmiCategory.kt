...
enum class BmiCategory(private val categoryId: Int, private val descriptionId: Int, private val colorId: Int, val pictureId: Int) {
    NA(R.string.empty_text, R.string.empty_text, R.color.colorPrimary, R.drawable.default_pic),
    UNDERWEIGHT(R.string.underweight, R.string.underweight_description, R.color.persianGreen, R.drawable.underweight_pic),
    ...
    fun getShortDescription(resources: Resources) = resources.getString(categoryId)

    fun getLongDescription(resources: Resources) = resources.getString(descriptionId)
